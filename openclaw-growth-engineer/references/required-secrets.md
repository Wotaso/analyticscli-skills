...
| `PADDLE_API_KEY` | Optional Paddle Billing metrics refresh | Optional, ask before setup | Metrics read access only. Use live account keys for production revenue trends; sandbox metrics are not production evidence |
