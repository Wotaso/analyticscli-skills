...
test('ASC wizard requests the report-creation role and vendor number', () => {
  ...
  assert.match(wizard, /You need two App Store Connect API keys/);
  ...
  assert.match(wizard, /Step 2 - temporary Admin key, used once/);
  assert.match(wizard, /Create a second API key named "Growth Engineer Setup Admin"/);
  assert.match(wizard, /Role: Admin/);
  ...
  assert.match(wizard, /Revoke this Admin key in App Store Connect after setup/);
