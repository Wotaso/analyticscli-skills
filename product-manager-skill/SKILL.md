...
This skill is deprecated and remains only as a migration target for old ClawHub installs.
...
Do not publish this alias as a full runtime skill again. `openclaw-growth-engineer` is the single source of truth.
